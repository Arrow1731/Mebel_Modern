...
export default function ProductsPage() {
  ...
  if (loading) return <p className="p-6 text-center text-[24px]">Yuklanmoqda…</p>;
  ...
  return (
    <main className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-6xl mx-auto px-4">
        ...
        {showForm && (
          <div className="fixed inset-0 bg-[#808080] bg-opacity-50 flex items-center justify-center z-50 p-[6px]">
            <Card className="w-full max-w-[800px] max-h-[800px] overflow-y-auto">
              <CardHeader>
